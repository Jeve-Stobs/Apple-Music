...
module.exports = {
  ...
  updateActivity: function (attributes) {
    ...
    if (
      app.mpris.service.metadata["mpris:trackid"] === MetaData["mpris:trackid"]
    ) {
      return;
    }
