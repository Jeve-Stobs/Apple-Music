...
exports.SettingsMenuInit = function () {
              ...
              fields: [
                ...
                },
                {
                  ...
                  options: [
                    {
                      label:
                        "Display your current song as your Discord Game activity",
                      value: true,
                    },
                  ],
                ...
                },
                {
                  ...
                  type: "checkbox",
                  options: [{ label: "Remove featuring artists", value: true }],
                },
                {
                  // LastFM Auth Key
              ...
              fields: [
                ...
                },
                {
                  ...
                  options: [
                    {
                      label:
                        "Removes certain UI elements and has unique scaling properties.",
                      value: true,
                    },
                  ],
                },
                {
                  ...
                  options: [
                    {
                      label:
                        "Removes the Open in iTunes and Exit Beta Buttons.",
                      value: true,
                    },
                  ],
                },
                {
                  ...
                  options: [
                    {
                      label:
                        "Removes the Apple Music Logo and moves search bar up.",
                      value: true,
                    },
                  ],
                },
...

                {
                  ...
                  options: [
                    {
                      label:
                        "Display a back button when going back is possible.",
                      value: true,
                    },
                  ],
                },
          ...
          groups: [
            {
              ...
              fields: [
                {
                  content:
                    "<p>Do not mess with these options unless you know what you're doing.</p>",
                  type: "message",
                },
                {
                ...
                },
                {
                  key: "alwaysOnTop",
                  type: "checkbox",
                  options: [{ label: "alwaysOnTop", value: true }],
                },
                {
                  // Turning on autoUpdaterBetaBuilds
                  key: "autoUpdaterBetaBuilds",
                  type: "checkbox",
                  options: [{ label: "autoUpdaterBetaBuilds", value: true }],
                },
                {
                  // Turning on useBeta
                  key: "useBetaSite",
                  type: "checkbox",
                  options: [{ label: "useBeta", value: true }],
                },
                {
                  // Turning on preventMediaKeyHijacking
                  key: "preventMediaKeyHijacking",
                  type: "checkbox",
                  options: [{ label: "preventMediaKeyHijacking", value: true }],
                },
                {
                ...
                },
                {
                  ...
                  type: "checkbox",
                  options: [{ label: "forceDisableWindowFrame", value: true }],
                ...
                },
                {
                  ...
                  key: "menuBarVisible",
                  type: "checkbox",
                  options: [{ label: "menuBarVisible", value: true }],
                },
                {
                  // Turning on removeScrollbars
                  key: "removeScrollbars",
                  type: "checkbox",
                  options: [{ label: "removeScrollbars", value: true }],
                },
                {
                  // Development Tools
                ...
                },
                {
                  ...
                  type: "checkbox",
                  options: [{ label: "themeDevelopment", value: true }],
                ...
                },
                {
                  ...
                  type: "checkbox",
                  options: [{ label: "allowMultipleInstances", value: true }],
                },
              ],
            },
          ],
  ...
  const ExistingConfigurationPath = path.resolve(
  ...
  try {
    console.log(
      `[OpenMenu][ConfigurationCheck] Checking for existing configuration at '${ExistingConfigurationPath}'`
    );
    if (fs.existsSync(ExistingConfigurationPath)) {
      console.log(
        `[OpenMenu][ConfigurationCheck] '${ExistingConfigurationPath}' exists!`
      );
      ...
      Object.keys(baseConfiguration).forEach(function (parentKey) {
        if (parentKey in userConfiguration) {
          Object.keys(baseConfiguration[parentKey]).forEach(function (
            childKey
          ) {
            if (!userConfiguration[parentKey].hasOwnProperty(childKey)) {
              console.log(
                `[OpenMenu][ConfigurationCheck][MissingKey] ${parentKey}.${childKey} - Value found in defaults: ${
                  baseConfiguration[parentKey][childKey].toString()
                    ? baseConfiguration[parentKey][childKey].toString()
                    : "[]"
                }`
              );
              app.preferences.value(
                `${parentKey}.${childKey}`,
                baseConfiguration[parentKey][childKey]
              );
            }
          });
        } else {
          console.log(
            `[OpenMenu][ConfigurationCheck][MissingKey] ${parentKey} - Value found in defaults: ${
              baseConfiguration[parentKey].toString()
                ? baseConfiguration[parentKey].toString()
                : "[]"
            }`
          );
  ...
  app.whenReady().then(() => {
    globalShortcut.register(
      app.preferences.value("advanced.settingsMenuKeybind"),
      () => {
