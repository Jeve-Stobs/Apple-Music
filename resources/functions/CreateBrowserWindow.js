  ...
  if (
    ...
    if (
      ...
      if (
        ...
        !app.preferences.value("visual.theme").includes("Template") &&
        !app.preferences.value("visual.theme").includes("default")
      ) {
        transparencyTheme = fetchTransparencyColor(
          app.preferences.value("visual.theme")
        );
      } else if (
        app.preferences.value("visual.theme").includes("default") ||
        ...
        // No Theme is Being Used
        transparencyTheme =
          nativeTheme.themeSource === "dark" ? "#0f0f0f00" : "#ffffff00";
      }
    } else {
