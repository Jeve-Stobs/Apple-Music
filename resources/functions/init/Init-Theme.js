...
exports.InitializeTheme = function () {
  ...
  if (!fs.existsSync(app.userThemesPath)) {
    ...
    console.log(
      `[InitializeTheme][copyThemes] Initial Themes have been copied to '${app.userThemesPath}'`
    );
  } else {
                ...
                fs.readFile(
                  ...
                  function (error) {
                    if (error) {
                      ...
                      console.log(
                        `[InitializeTheme][access] Setting permissions of '${join(
                          app.userThemesPath,
                          value
                        )}'`
                      );
